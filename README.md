...
The project is for learning and hacking gstreamer.


### Basics

* [gobject](https://github.com/ToshioCP/Gobject-tutorial)
* [gobject-examples](https://github.com/zorgnax/gobject-examples/blob/master/01-media-from-book/media.c)
* [gobject-introspection](https://gi.readthedocs.io/en/latest/build_test.html)
